...
if($_SESSION["islogged"]!="default"){
	...
	echo "<div id='page-area'><div id='error'><p>Username and password don't match. Click here <a href='index.php?action=recovery'>åäþ</a>to recover your credentials.</p></div></div>";
}
  else {
...
if(isset($_POST["type"]) && $_POST["type"]=='add' && $_POST["product_qty"]>0)
{
    ...
    while($statement->fetch()){
        ...
        //fetch product name, price Srom db and add to new_product array
